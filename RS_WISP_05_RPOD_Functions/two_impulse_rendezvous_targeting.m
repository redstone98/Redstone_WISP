function [Delta_v_0, Delta_v_f, delta_r_t_mat, delta_v_t_mat, v_plus_ECI, t_vector] = two_impulse_rendezvous_targeting(r_target, v_target, r_chaser, v_chaser, delta_r_final,tf)
...
delta_v_0_plus = inv(Phi_rv_tf) * (delta_r_final -  Phi_rr_tf * delta_r_0);
